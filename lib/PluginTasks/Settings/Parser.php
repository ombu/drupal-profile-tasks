...
/**
 * @file
 * Settings parser for ProfileTasks installer tasks.
 */

namespace ProfileTasks\Settings;
 ...
 * Settings Parser
 *
 * Loads default yaml file from profile_tasks/config directory, then searches the
...
class Parser {
  ...
  public function parse($applyOverrides = TRUE) {
    ...
    $config_file = $this->getFileName('module', 'profile_tasks');
    ...
    // settings that's not in profile_tasks.
