...
use ProfileTasks\Content\WrapperException;
...
class AddContent extends Task {
  ...
  protected function loadNodeFromFile($name) {
    ...
    try {
      // Include content file. It should create a new \ProfileTasks\Content\Wrapper
      // object.
      include $path;
      ...
      foreach ($vars as $var) {
        if ($var instanceof \ProfileTasks\Content\Wrapper) {
          $wrapper = $var;
          break;
        }
      }
